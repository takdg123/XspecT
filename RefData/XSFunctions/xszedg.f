      SUBROUTINE xszedg(ear, ne, param, ifl, photar, photer)
...
c		1	redshift
c		2	edgeE	the threshold energy
c		3	maxAbs	the maximum absorption factor at threshold
...
c		m(e) = exp(-maxabs*((E/edgeE)**-3))
      ...
      REAL cedgei, abs, alow, ahi, xold, x, amax, zfac
      INTEGER ie
      LOGICAL qedge
