...
void vsedov(const RealArray& energyArray, const RealArray& params,
	    ...
	    const string& initString)
{
  ...
  Real TraceAbund = getNEItraceAbund(Zinput, abundance, "vsedov");

  // set parameters to pass through to vvsedov
  ...
  vvsedov(energyArray, vvpar, spectrumNumber, flux, fluxErr, initString);
