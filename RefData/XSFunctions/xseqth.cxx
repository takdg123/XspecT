...
//
//      SUBROUTINE XSEQTH(Ear,Ne,Param,Ifl,Photar,Photer)
//      IMPLICIT NONE
//      INTEGER Ne , Ifl
...
void xseqth(const RealArray& energyArray, const RealArray& params,
	    int spectrumNumber, RealArray& flux, RealArray& fluxErr, 
	    const string& initString)
{
  eqpwrap(energyArray, params, flux, fluxErr, 2);
}
