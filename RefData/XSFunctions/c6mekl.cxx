...
/*
  ...
  c kaa  12/21/17   translated to C++
  c Disclaimer: Any resemblance to a real program is purely
  c             coincidental
  c
*/

void c6mekl(const RealArray& energyArray, const RealArray& params,
	    ...
	    const string& initString)  
{
  ...
  c6vmekl(energyArray, pparams, spectrumNumber, flux, fluxErr, initString);
}
