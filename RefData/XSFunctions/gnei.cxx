...
void gnei(const RealArray& energyArray, const RealArray& params,
	  ...
	  const string& initString)
{
   ...
   // Call the vgnei subroutine for variable abundances.

   vgnei(energyArray, vparam, spectrumNumber, flux, fluxErr, initString);
}
