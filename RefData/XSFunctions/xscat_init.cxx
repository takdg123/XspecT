...
void xscat_init(int *Nmodel, struct SIGMA_TABLE *xscatdata[]) {
  ...
  *Nmodel=0;
  ...
  string mrnfile  = DirName + "/xscat_MRN_v1.1.0.fits";
  string wd1file  = DirName + "/xscat_WD3100AGAL_v1.0.0.fits";
  string zda1file = DirName + "/xscat_ZDABAS_v1.1.0.fits";
