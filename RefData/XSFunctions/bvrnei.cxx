...
void bvrnei(const RealArray& energyArray, const RealArray& params,
	    ...
	    const string& initString)
{
  ...
  bvvrnei(energyArray, vvpar, spectrumNumber, flux, fluxErr, initString);
