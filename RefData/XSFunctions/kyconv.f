...
c===============================================================================
      ...
      real idre_param(12)
      integer ne_loc,ierr,ne_loc_old,i,j,ntable
...
c     silly line to remove a compiler warning. ne_loc is reset to param(11) below.
      ne_loc = ifl
