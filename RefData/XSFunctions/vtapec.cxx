...
void vtapec(const RealArray& energyArray, const RealArray& params, 
	    ...
	    const string& initString)
{
  ...
  abun[0] = 1.0;
  for (size_t i=1; i<nAp; i++) abun[i] = params[i+1];

  Real T = params[0];
  Real Tb = params[1];
  Real z = params[15];
  calcMultiTempPlasma(energyArray, 6, Zarray, abun, (Real)1.0, z, T, Tb,
